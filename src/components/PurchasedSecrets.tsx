...
const PurchasedSecrets: FC = () => {
  ...
  return <>
    <h1 className="text-2xl font-light dark:text-white mt-10 mb-6">Unlocked Content</h1>
    {myPurchasedSecrets.length > 0 ?
      ...
      </div> : <p className="text-base font-light dark:text-gray-300 ml-2">You have not unlocked any content yet. Sign in and purchase some content to see it decrypted!</p>}
  </>
}
